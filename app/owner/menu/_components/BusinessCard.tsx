    ...
    <article className={`group relative flex h-full flex-col overflow-visible rounded-3xl border border-slate-200/80 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-[#00C897] hover:shadow-xl ${!isActive ? "bg-slate-50/50" : ""}`}>
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        {isActive ? (
          ...
          <div className="mt-4 mb-5 rounded-xl border border-amber-100 bg-amber-50/50 p-3.5 text-center"><p className="text-xs font-semibold text-amber-800">Sistem Dalam Pemeliharaan</p><p className="mt-0.5 text-[11px] text-amber-600/80">Pengaturan dapat diperbarui melalui detail toko.</p></div>
        )}
      </div>
